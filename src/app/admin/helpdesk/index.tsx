...
export default function AdminHelpdeskInboxScreen() {
  ...
  return (
    <View className="flex-1 bg-zen-bg dark:bg-zen-darkBg">
      {/* Header */}
      <View className="px-4 pt-12 pb-4 bg-white dark:bg-stone-950 shadow-sm flex-row items-center border-b border-stone-100 dark:border-stone-900">
        <TouchableOpacity
          onPress={() => router.back()}
        ...
        <View className="flex-1">
          <Text className="font-display font-black text-lg text-stone-900 dark:text-white">Kotak Bantuan Warga</Text>
          <Text className="font-sans text-[10px] text-stone-400 dark:text-stone-500 uppercase tracking-widest mt-0.5">
            Moderasi percakapan AI & warga
          </Text>
        </View>
      </View>

      {/* Search Bar */}
      <View className="p-4 bg-white dark:bg-stone-950 border-b border-stone-100 dark:border-stone-900">
