  ...
  return (
    <View className="flex-1 bg-zen-bg dark:bg-zen-darkBg">
      ...
      <View className="pt-12 pb-4 px-4 flex-row items-center bg-white dark:bg-zen-darkBg shadow-sm z-10">
        ...
        <Text className="font-display text-xl font-bold text-gray-900 dark:text-white">Feed Laporan Publik</Text>
      </View>
        ...
        >
          {reports.length === 0 ? (
            <View className="py-10 items-center">
              <Text className="font-sans text-gray-500">Belum ada laporan publik.</Text>
            </View>
          ) : (
            reports.map((report) => (
              <TouchableOpacity 
