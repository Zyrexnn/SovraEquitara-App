...
export default function SuperAdminHub() {
  ...
  return (
    <View className="flex-1 bg-zen-bg dark:bg-zen-darkBg">
      {/* Header */}
      <View className="pt-14 pb-4 px-4 bg-white dark:bg-zen-cardBg border-b border-gray-100 dark:border-gray-800 flex-row items-center justify-between">
        ...
        <View className="flex-row items-center gap-2">
          <View className="bg-amber-100 dark:bg-amber-950/40 px-3 py-1.5 rounded-full flex-row items-center">
      ...
      >
        ...
        <TouchableOpacity 
          ...
          className="mb-4"
        >
          <BentoCard className="flex-row items-center p-4 rounded-3xl">
            ...
            <Text className="font-sans text-gray-400 font-bold text-base">→</Text>
          </BentoCard>
        </TouchableOpacity>
        ...
        {/* Security & Info */}
        <BentoCard className="p-4 bg-gray-50/50 dark:bg-zen-cardBg border border-gray-100 dark:border-gray-800/80 rounded-3xl">
